...
if(isset($_REQUEST["submit"])){
  ...
  $query=mysqli_query($link,"select * from users where username='$user' && password='$pass'");
...
<div class="login-form">    
    ...
    <br><br>
    <div class="text-center small">Authorized Only :<a href="admin_login.php">&nbsp;ADMIN LOGIN</a></div>
</div>
</body>
</html>   
