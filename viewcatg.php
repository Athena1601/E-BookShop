<!-- view books category (admin operation) -->
<!DOCTYPE html>
<html lang="en">
  <head>
...
th, td {
 ...
 <ul style="list-style-type:none;margin-top: 2%;">
    ...
    <li style="display:inline"><button onclick="location.href='viewcatg.php'" style="color: white;
  background-color: #646464;">VIEW CATEGORIES</button></li>
...
<br><br> 
   ...
   if ($result= mysqli_query($mysqli,"SELECT cat_id,cat_name FROM category ORDER BY cat_id")){
    echo "<table>";
    echo "<tr>";
