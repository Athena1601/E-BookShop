<!-- view all customers (admin operation) -->
...
th, td {
 ...
 <ul style="list-style-type:none;margin-top: 2%;">
    ...
    <li style="display:inline"><button  onclick="location.href='viewcust.php'" style="color: white;
  background-color: #646464;">VIEW CUSTOMERS</button></li>
...
<br><br> 
   ...
   if ($result= mysqli_query($mysqli,"SELECT user_id,username,email FROM users ORDER BY user_id")){
    echo "<table>";
    echo "<tr>";
