<!-- code to add new book (admin operation) -->
...
<br><br> 
    ...
    <tr>
     ...
     <tr>
        ...
        <td><textarea rows="4" cols="40" name="b_desc" required></textarea></td>
     </tr>
     ...
     <tr>
        ...
        <td><input type="file" accept="image/*" name="image" style="padding: 2%;" required></td>
     </tr>
